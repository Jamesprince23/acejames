...
public class BuilderPattern{
	public static void main(String[] args) {
		Car myCar=new Car.CarBuilder().setEngine("").setColor("red").setCc(5000).setFuelTankCapacity(30).setTyre("JSW").build();
...
class Car{
	class Parts{
		...
		public String toString() {
			return "Parts [engine=" + engine +  ", tyre=" + tyre + ", color=" + color
